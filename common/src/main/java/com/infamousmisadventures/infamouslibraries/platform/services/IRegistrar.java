...
import com.infamousmisadventures.infamouslibraries.InfamousLibraries;
...
public interface IRegistrar {
    ...
    /**
     * Main method for this service interface, called in {@link InfamousLibraries} in order to load it and its loader-specific implementations accordingly. Should NOT be called anywhere else!
     */
    void setupRegistrar();
